/**
 * 
 * Расширяем структуру связного списка до двусвязного. Мы научились работать с
 * односвязным список, теперь можно ближе познакомиться со структурой
 * двусвязного списка и особенностей его внутреннего строения. Стоит напомнить
 * студентам, что двусвязный список представляет из себя цепочку элементов,
